        ...
        <div class="row">
            <div class="col">
                <ul>
                    <li>
                        <a><span>
                                <input type="image" src="/images/MaritalStatus_Married.png"
                    ...
                    <li>
                        <a><span>
                                <input type="image" src="/images/MaritalStatus_Separated.png"
                    ...
                    <li>
                        <a><span>
                                <input type="image" src="/images/MaritalStatus_Single.png"
